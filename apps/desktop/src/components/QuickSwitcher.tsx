...
export function QuickSwitcher({ recentNotes, onSearch, onSelect, onCreate, onClose }: QuickSwitcherProps) {
  ...
  return (
    <div
      className="animate-fade-in fixed inset-0 z-50 flex items-start justify-center bg-slate-900/40 pt-[15vh] backdrop-blur-[2px]"
      onMouseDown={onClose}
    >
      <div
      ...
      >
        ...
        <div className="flex items-center gap-3 border-t border-line-soft px-4 py-2 text-[11px] text-ink-faint">
