...
contextBridge.exposeInMainWorld("simplekasten", {
  vault: {
    ...
    restoreNoteVersion: (noteId, versionId) => ipcRenderer.invoke("vault:restoreNoteVersion", noteId, versionId),
    listCanvases: () => ipcRenderer.invoke("vault:listCanvases"),
    createCanvas: (input) => ipcRenderer.invoke("vault:createCanvas", input),
